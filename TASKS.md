...
- [ ] Four of six actor re-test runs merged two conflicting source statements (30-day trigger, 14-day window) into a timeline the source doesn't state, then flagged it. Consider a rule: keep a contradiction as the source states it and flag it; don't resolve it in the revision.
