...
In ordinary text sentences (as opposed to, say, [code samples](https://developers.google.com/style/code-samples)), use code font to mark up most things that have anything to do with code. Code font helps to clarify for your reader which text refers to an entity in these ways:
...
If a [UI element](https://developers.google.com/style/ui-elements#formatting) meets the [requirements for code font](#code), then use both code font and bold for that element.
